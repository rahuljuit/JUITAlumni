...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Welcome To JUIT Alumni Networks!!!!</h2>
			...
			<div class="row about_row">
				...
				<div class="col-lg-4 about_col about_col_left">
					<div class="about_item">
						<div class="about_item_image"><img src="background_2.jpg" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_middle">
					<div class="about_item">
						<div class="about_item_image"><img src="background_3.jpg" alt=""></div>
				...
				<div class="col-lg-4 about_col about_col_right">
					<div class="about_item">
						<div class="about_item_image"><img src="first.jpg" alt=""></div>
	...
	<div class="feature">
		<div class="feature_background" style="background-image:url(fourth.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
			...
			<div class="row feature_row">
				...
				<div class="col-lg-6 feature_col">
					<div class="feature_video d-flex flex-column align-items-center justify-content-center">
						<div class="feature_video_background" style="background-image:url(forvideo.jpg)"></div>
						<a class="vimeo feature_video_button" href="https://www.youtube.com/watch?v=puMI1eRUHIw">
